package com.sh303.sms.sms.cloud;
...
@Slf4j
@Service
public class CloudSmsService implements SmsService {
    ...
    static final Logger logger = LoggerFactory.getLogger(CloudSmsService.class);
     ...
     */
    @Override
    public void sendSms(String mobile, String code, String signName, String template) {
        //可自助调整超时时间
        ...
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou",
                smsPropertiesInfo.getAccessKeyId(), smsPropertiesInfo.getAccessKeySecret());
        ...
        try {
            ...
            log.error(e.getMessage());
            throw new BusinessException(CommonErrorCode.E_100107, CommonErrorCode.E_100107.getDesc());
        }
